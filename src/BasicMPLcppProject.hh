...
///
/// file: BasicMPLcppProject.hh
///

#pragma once

#ifndef INCLUDE_BASICMPLCPPPROJECT
#define INCLUDE_BASICMPLCPPPROJECT

// Print BasicMPLcppProject errors
#ifndef BASICMPLCPPPROJECT_ERROR
#define BASICMPLCPPPROJECT_ERROR(MSG)                \
  {                                     \
...
// Check for BASICMPLCPPPROJECT errors
#ifndef BASICMPLCPPPROJECT_ASSERT
#define BASICMPLCPPPROJECT_ASSERT(COND, MSG) \
  if (!(COND))                  \
  BASICMPLCPPPROJECT_ERROR(MSG)
#endif
...
//! Namespace containing all BASICMPLCPPPROJECT typedefs, classes and routines
namespace mpl
{
  ...
  typedef Eigen::Matrix<real, 5, 1>                           vec5; //!< 4x1 vector type (column vector)
